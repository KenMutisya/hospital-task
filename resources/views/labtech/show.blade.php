        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex">
                ...
                <div class="w-1/2 ml-6">
                    <form action="{{ route('labtech.store') }}" method="POST">
                        @csrf
                        <input type="hidden" name="appointment_id" value="{{ $appointment->id }}">
                        <div>
                            <label for="comment" class="block text-sm font-medium leading-6 text-gray-900">Diagnosis</label>
                            <div class="mt-2">
                            <textarea rows="4" name="diagonsis" id="diagonsis"
                                      class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $appointment->diagonsis }}</textarea>
                            </div>
                        </div>
